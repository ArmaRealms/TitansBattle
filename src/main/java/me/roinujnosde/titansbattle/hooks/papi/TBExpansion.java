...
public class TBExpansion extends PlaceholderExpansion {
    ...
    static {
        ...
        PLACEHOLDERS = Arrays.asList("%titansbattle_arena_in_use_<arena>%", "%titansbattle_last_<killer|winner>_<game>%", "%titansbattle_last_winner_group_<game>%",
                "%titansbattle_<game>_<killer|winner>_prefix%", "%titansbattle_group_total_victories%",
